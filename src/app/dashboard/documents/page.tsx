...
export default function DocumentsPage() {
  ...
  const mockDocuments = [
    { id: 1, name: 'Business Plan.pdf', size: '2.4 MB', uploaded: '2024-01-15', type: 'PDF' },
    { id: 2, name: 'Financial Report.xlsx', size: '1.8 MB', uploaded: '2024-01-14', type: 'Excel' },
    { id: 3, name: 'Contract Agreement.docx', size: '856 KB', uploaded: '2024-01-13', type: 'Word' },
    { id: 4, name: 'Presentation.pptx', size: '5.2 MB', uploaded: '2024-01-12', type: 'PowerPoint' },
    { id: 5, name: 'Invoice Template.pdf', size: '324 KB', uploaded: '2024-01-11', type: 'PDF' },
  ]
    ...
    <div className="p-8">
      ...
      <div className="bg-white/10 backdrop-blur-xl rounded-xl border border-white/20 shadow-xl overflow-hidden">
            ...
            <tbody>
              {mockDocuments.map((doc) => (
                <tr key={doc.id} className="border-b border-white/10 hover:bg-white/5 transition-colors">
                  ...
                  <td className="px-6 py-4 text-white/70">{doc.type}</td>
                  <td className="px-6 py-4 text-white/70">{doc.size}</td>
                  <td className="px-6 py-4 text-white/70">{doc.uploaded}</td>
                  <td className="px-6 py-4">
                    <div className="flex space-x-2">
        ...
        <div className="p-6 border-t border-white/10">
          <div className="flex items-center justify-between">
            <p className="text-white/70">Showing 5 of 24 documents</p>
            <div className="flex space-x-2">
